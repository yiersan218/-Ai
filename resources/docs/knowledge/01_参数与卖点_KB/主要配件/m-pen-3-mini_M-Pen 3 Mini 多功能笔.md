...
source_urls: ["https://www.vmall.com/product/comdetail/index.html?prdId=10086270785193&sbomCode=3104230013802"]
...
| 字段 | 官网快照 |
|---|---|
| 官网商品名称 | HUAWEI M-Pen 3 Mini 多功能笔 |
| 商品编号（prdId） | 10086270785193 |
| 品牌 | 华为 |
| 销售 SKU 数量 | 1 |
| 建议刷新日期 | 2026-08-13；超过该日期的时效性问题视为证据不足 |
| 默认 SKU | 3104230013802；HUAWEI M-Pen 3 Mini 多功能笔 雪域白 |
| SKU 页面标价区间（抓取时） | ¥599 |
| 商城搜索列表促销价（抓取时） | ¥599 |
| 店铺 | 华为商城自营 |
| 官网卖点摘要 | AI 一键即达；语音交互；磁吸充电 |
| 用户评价快照（抓取时） | 好评率 97%；评价数 32 |
| 官网商品页 | https://www.vmall.com/product/comdetail/index.html?prdId=10086270785193 |
...
|---|---|---|---:|---|---|
| 3104230013802 | HUAWEI M-Pen 3 Mini 多功能笔 雪域白（默认） | 颜色=雪域白 | ¥599 |  | 显示购买入口 |
