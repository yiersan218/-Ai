...
source_urls: ["https://www.vmall.com/product/comdetail/index.html?prdId=10086825800605&sbomCode=3102020059501"]
...
| 字段 | 官网快照 |
|---|---|
| 官网商品名称 | 华为超级快充电源适配器（Max 140 W） |
| 商品编号（prdId） | 10086825800605 |
| 品牌 | 华为 |
| 销售 SKU 数量 | 1 |
| 建议刷新日期 | 2026-08-13；超过该日期的时效性问题视为证据不足 |
| 默认 SKU | 3102020059501；华为超级快充电源适配器（Max 140 W）氮化镓 GaN 充电器套装 1.8 米线【3C认证】 |
| SKU 页面标价区间（抓取时） | ¥199 |
| 商城搜索列表促销价（抓取时） | ¥199 |
| 店铺 | 华为商城自营 |
| 官网卖点摘要 | 超级快充 Turbo；多协议、多设备兼容；1.8 米加长充电线 |
| 用户评价快照（抓取时） | 好评率 98%；评价数 2034 |
| 官网商品页 | https://www.vmall.com/product/comdetail/index.html?prdId=10086825800605 |
...
|---|---|---|---:|---|---|
| 3102020059501 | 华为超级快充电源适配器（Max 140 W）氮化镓 GaN 充电器套装 1.8 米线【3C认证】（默认） | 颜色=白色 | ¥199 |  | 显示购买入口 |
...
- CCC认证，超级快充 Turbo，多协议、多设备兼容，1.8 米加长充电线
