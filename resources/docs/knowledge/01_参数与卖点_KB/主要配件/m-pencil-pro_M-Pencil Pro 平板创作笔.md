...
source_urls: ["https://www.vmall.com/product/comdetail/index.html?prdId=10086149128760&sbomCode=3105030006601"]
...
| 字段 | 官网快照 |
|---|---|
| 官网商品名称 | HUAWEI M-Pencil Pro 平板创作笔 |
| 商品编号（prdId） | 10086149128760 |
| 品牌 | 华为 |
| 销售 SKU 数量 | 1 |
| 建议刷新日期 | 2026-08-13；超过该日期的时效性问题视为证据不足 |
| 默认 SKU | 3105030006601；HUAWEI M-Pencil Pro 平板创作笔 雪域白 |
| SKU 页面标价区间（抓取时） | ¥699 |
| SKU 限时活动价区间（抓取时） | ¥559 |
| 商城搜索列表促销价（抓取时） | ¥559 |
| 店铺 | 华为商城自营 |
| 官网卖点摘要 | 全新笔尾智慧键 |
| 用户评价快照（抓取时） | 好评率 99%；评价数 2256 |
| 官网商品页 | https://www.vmall.com/product/comdetail/index.html?prdId=10086149128760 |
...
|---|---|---|---:|---|---|
| 3105030006601 | HUAWEI M-Pencil Pro 平板创作笔 雪域白（默认） | 颜色=雪域白 | ¥699 | ¥559（直降140元；2026-08-01 00:00:00+0800 至 2026-08-31 23:59:59+0800） | 显示购买入口 |
...
- 全新笔尾智慧键，唤醒 AI 语音交互，多样笔尖，写绘皆专业，轻捏、震动、侧旋，高效手势交互
