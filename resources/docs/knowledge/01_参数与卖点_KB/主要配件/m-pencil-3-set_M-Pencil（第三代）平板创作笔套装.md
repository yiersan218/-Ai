...
source_urls: ["https://www.vmall.com/product/comdetail/index.html?prdId=10086167840443&sbomCode=3105030004201"]
...
| 字段 | 官网快照 |
|---|---|
| 官网商品名称 | HUAWEI M-Pencil（第三代）平板创作笔套装 |
| 商品编号（prdId） | 10086167840443 |
| 品牌 | 华为 |
| 销售 SKU 数量 | 1 |
| 建议刷新日期 | 2026-08-13；超过该日期的时效性问题视为证据不足 |
| 默认 SKU | 3105030004201；HUAWEI M-Pencil（第三代）平板创作笔套装 |
| SKU 页面标价区间（抓取时） | ¥649 |
| SKU 限时活动价区间（抓取时） | ¥449 |
| 商城搜索列表促销价（抓取时） | ¥449 |
| 店铺 | 华为商城自营 |
| 官网卖点摘要 | 专业写绘 |
| 用户评价快照（抓取时） | 好评率 98%；评价数 2622 |
| 官网商品页 | https://www.vmall.com/product/comdetail/index.html?prdId=10086167840443 |
...
|---|---|---|---:|---|---|
| 3105030004201 | HUAWEI M-Pencil（第三代）平板创作笔套装（默认） | 颜色=雪域白 | ¥649 | ¥449（直降200元；2026-08-01 00:00:00+0800 至 2026-08-31 23:59:59+0800） | 显示购买入口 |
