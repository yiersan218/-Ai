...
source_urls: ["https://www.vmall.com/product/comdetail/index.html?prdId=10086822159053&sbomCode=3102020071401"]
...
| 字段 | 官网快照 |
|---|---|
| 官网商品名称 | 华为超级快充充电器（Max 40 W） |
| 商品编号（prdId） | 10086822159053 |
| 品牌 | 华为 |
| 销售 SKU 数量 | 1 |
| 建议刷新日期 | 2026-08-13；超过该日期的时效性问题视为证据不足 |
| 默认 SKU | 3102020071401；华为超级快充充电器（Max 40 W）白色 含 5A A-C 1.0 米数据线【3C认证】 |
| SKU 页面标价区间（抓取时） | ¥79 |
| 商城搜索列表促销价（抓取时） | ¥79 |
| 店铺 | 华为商城自营 |
| 官网卖点摘要 | 40 W 超级快充 |
| 用户评价快照（抓取时） | 好评率 98%；评价数 536 |
| 官网商品页 | https://www.vmall.com/product/comdetail/index.html?prdId=10086822159053 |
...
|---|---|---|---:|---|---|
| 3102020071401 | 华为超级快充充电器（Max 40 W）白色 含 5A A-C 1.0 米数据线【3C认证】（默认） | 颜色=白色 | ¥79 |  | 显示购买入口 |
