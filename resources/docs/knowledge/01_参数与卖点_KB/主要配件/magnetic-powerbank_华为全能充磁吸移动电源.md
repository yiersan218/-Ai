...
source_urls: ["https://www.vmall.com/product/comdetail/index.html?prdId=10086225014224&sbomCode=3102010027101"]
...
|---|---|
| 官网商品名称 | 华为全能充磁吸移动电源 |
| 商品编号（prdId） | 10086225014224 |
| 品牌 | 华为 |
| 销售 SKU 数量 | 1 |
| 建议刷新日期 | 2026-08-13；超过该日期的时效性问题视为证据不足 |
| 默认 SKU | 3102010027101；华为全能充磁吸移动电源 陶瓷白 含 3.3A C-C 0.25 米数据线【3C认证】 |
| SKU 页面标价区间（抓取时） | ¥369 |
| SKU 限时活动价区间（抓取时） | ¥239 |
| 商城搜索列表促销价（抓取时） | ¥239 |
| 店铺 | 华为商城自营 |
| 官网卖点摘要 | CCC认证 |
| 用户评价快照（抓取时） | 好评率 93%；评价数 7944 |
| 官网商品页 | https://www.vmall.com/product/comdetail/index.html?prdId=10086225014224 |
...
|---|---|---|---:|---|---|
| 3102010027101 | 华为全能充磁吸移动电源 陶瓷白 含 3.3A C-C 0.25 米数据线【3C认证】（默认） | 颜色=陶瓷白 | ¥369 | ¥239（直降130元；2026-08-01 00:00:00+0800 至 2026-08-31 23:59:59+0800） | 显示购买入口 |
...
- CCC认证 ，13 重安全防护 ，可上飞机，磁吸功能需搭配官方磁吸壳使用（HUAWEI Pura80 系列无法使用该移动电源的无线充电功能，需搭配数据线使用）
