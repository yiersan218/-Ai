...
source_urls: ["https://www.vmall.com/product/comdetail/index.html?prdId=10086826293656&sbomCode=3102020059201"]
...
| 字段 | 官网快照 |
|---|---|
| 官网商品名称 | 华为全能充多口充电器（Max 100 W） |
| 商品编号（prdId） | 10086826293656 |
| 品牌 | 华为 |
| 销售 SKU 数量 | 1 |
| 建议刷新日期 | 2026-08-13；超过该日期的时效性问题视为证据不足 |
| 默认 SKU | 3102020059201；华为全能充多口充电器（Max 100 W）白色 含 6A C-C 1.8 米数据线【3C认证】 |
| SKU 页面标价区间（抓取时） | ¥349 |
| SKU 限时活动价区间（抓取时） | ¥229 |
| 商城搜索列表促销价（抓取时） | ¥229 |
| 店铺 | 华为商城自营 |
| 官网卖点摘要 | 100 W 大功率；双口功率动态分配；可折叠插脚 |
| 用户评价快照（抓取时） | 好评率 98%；评价数 7507 |
| 官网商品页 | https://www.vmall.com/product/comdetail/index.html?prdId=10086826293656 |
...
|---|---|---|---:|---|---|
| 3102020059201 | 华为全能充多口充电器（Max 100 W）白色 含 6A C-C 1.8 米数据线【3C认证】（默认） | 颜色=白色；版本=常规版 | ¥349 | ¥229（直降120元；2026-08-01 00:00:00+0800 至 2026-08-31 23:59:59+0800） | 显示购买入口 |
...
- CCC认证，100 W 大功率，双口功率动态分配，可折叠插脚
