...
source_urls: ["https://www.vmall.com/product/comdetail/index.html?prdId=10086393994098&sbomCode=3102030014001"]
...
| 字段 | 官网快照 |
|---|---|
| 官网商品名称 | 华为 6A 数据线 USB-A 转 USB-C |
| 商品编号（prdId） | 10086393994098 |
| 品牌 | 华为 |
| 销售 SKU 数量 | 1 |
| 建议刷新日期 | 2026-08-13；超过该日期的时效性问题视为证据不足 |
| 默认 SKU | 3102030014001；华为 6A 数据线 USB Type-A 转 USB Type-C（白色）1m |
| SKU 页面标价区间（抓取时） | ¥59 |
| SKU 限时活动价区间（抓取时） | ¥39 |
| 商城搜索列表促销价（抓取时） | ¥39 |
| 店铺 | 华为商城自营 |
| 官网卖点摘要 | 支持 6A 大电流 |
| 用户评价快照（抓取时） | 好评率 98%；评价数 230411 |
| 官网商品页 | https://www.vmall.com/product/comdetail/index.html?prdId=10086393994098 |
...
|---|---|---|---:|---|---|
| 3102030014001 | 华为 6A 数据线 USB Type-A 转 USB Type-C（白色）1m（默认） | 颜色=白色；规格=6A；长度=1m | ¥59 | ¥39（直降20元；2026-08-01 00:00:00+0800 至 2026-08-31 23:59:59+0800） | 显示购买入口 |
...
- 支持 6A 大电流，高品质线芯，双面导电铝箔屏蔽，1 米线长
