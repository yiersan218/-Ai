...
source_urls: ["https://www.vmall.com/product/comdetail/index.html?prdId=10086875293502&sbomCode=3102030030601"]
...
| 字段 | 官网快照 |
|---|---|
| 官网商品名称 | 华为编织数据线（Max 120 W） |
| 商品编号（prdId） | 10086875293502 |
| 品牌 | 华为 |
| 销售 SKU 数量 | 1 |
| 建议刷新日期 | 2026-08-13；超过该日期的时效性问题视为证据不足 |
| 默认 SKU | 3102030030601；华为编织数据线（Max 120 W）6A 1.8m USB Type-C 转 USB Type-C |
| SKU 页面标价区间（抓取时） | ¥99 |
| 商城搜索列表促销价（抓取时） | ¥99 |
| 店铺 | 华为商城自营 |
| 官网卖点摘要 | 高强度编织纱线；120 W 大功率；适配 USB-C 接口手机电脑平板 |
| 用户评价快照（抓取时） | 好评率 99%；评价数 8570 |
| 官网商品页 | https://www.vmall.com/product/comdetail/index.html?prdId=10086875293502 |
...
|---|---|---|---:|---|---|
| 3102030030601 | 华为编织数据线（Max 120 W）6A 1.8m USB Type-C 转 USB Type-C（默认） | 颜色=白哑银；规格=6A；长度=1.8m；版本=常规版 | ¥99 |  | 显示购买入口 |
...
- 高强度编织纱线，120 W 大功率，适配 USB-C 接口手机电脑平板
