...
source_urls: ["https://www.vmall.com/product/comdetail/index.html?prdId=10086400057044&sbomCode=3102020070501"]
...
| 字段 | 官网快照 |
|---|---|
| 官网商品名称 | 华为全能充多口充电器（Max 100 W）黑色 尊享版 |
| 商品编号（prdId） | 10086400057044 |
| 品牌 | 华为 |
| 销售 SKU 数量 | 1 |
| 建议刷新日期 | 2026-08-13；超过该日期的时效性问题视为证据不足 |
| 默认 SKU | 3102020070501；华为全能充多口充电器（Max 100 W）黑色 尊享版 |
| SKU 页面标价区间（抓取时） | ¥299 |
| 商城搜索列表促销价（抓取时） | ¥299 |
| 店铺 | 华为商城自营 |
| 官网卖点摘要 | 100 W 超级快充 |
| 用户评价快照（抓取时） | 好评率 99%；评价数 1755 |
| 官网商品页 | https://www.vmall.com/product/comdetail/index.html?prdId=10086400057044 |
...
|---|---|---|---:|---|---|
| 3102020070501 | 华为全能充多口充电器（Max 100 W）黑色 尊享版（默认） | 颜色=黑色 | ¥299 |  | 显示购买入口 |
...
- 100 W 超级快充，双口智能快充，高强度编织纱线，多重安全防护
