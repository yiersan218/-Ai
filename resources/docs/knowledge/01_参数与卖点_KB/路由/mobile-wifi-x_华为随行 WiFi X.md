...
source_urls: ["https://www.vmall.com/product/comdetail/index.html?prdId=10086749308221&sbomCode=3001030015201"]
...
|---|---|
| 官网商品名称 | 华为随行 WiFi X |
| 商品编号（prdId） | 10086749308221 |
| 品牌 | 华为 |
| 销售 SKU 数量 | 1 |
| 建议刷新日期 | 2026-08-13；超过该日期的时效性问题视为证据不足 |
| 默认 SKU | 3001030015201；华为随行 WiFi X 银色（中国移动专用） |
| SKU 页面标价区间（抓取时） | ¥2499 |
| 商城搜索列表促销价（抓取时） | ¥2499 |
| 店铺 | 华为商城自营 |
| 官网卖点摘要 | 随行高速 WiFi；千兆上行；移动 VIP 五重网络保障 |
| 用户评价快照（抓取时） | 好评率 88%；评价数 74 |
| 官网商品页 | https://www.vmall.com/product/comdetail/index.html?prdId=10086749308221 |
...
|---|---|---|---:|---|---|
| 3001030015201 | 华为随行 WiFi X 银色（中国移动专用）（默认） | 颜色=银色 | ¥2499 |  | 显示购买入口 |
...
- 千兆上行，16 根蜂窝天线，中国移动 VIP 五重网络保障，20 小时超长续航，长效直播不断电
