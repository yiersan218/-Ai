...
source_urls: ["https://www.vmall.com/product/comdetail/index.html?prdId=10086968106111&sbomCode=3001030012301"]
...
|---|---|
| 官网商品名称 | 华为移动路由 2 |
| 商品编号（prdId） | 10086968106111 |
| 品牌 | 华为 |
| 销售 SKU 数量 | 1 |
| 建议刷新日期 | 2026-08-13；超过该日期的时效性问题视为证据不足 |
| 默认 SKU | 3001030012301；华为移动路由 2 白色 |
| SKU 页面标价区间（抓取时） | ¥299 |
| SKU 限时活动价区间（抓取时） | ¥269 |
| 商城搜索列表促销价（抓取时） | ¥269 |
| 店铺 | 华为商城自营 |
| 官网卖点摘要 | 4G 全网通；轻薄便携；免装宽带 |
| 用户评价快照（抓取时） | 好评率 93%；评价数 645 |
| 官网商品页 | https://www.vmall.com/product/comdetail/index.html?prdId=10086968106111 |
...
|---|---|---|---:|---|---|
| 3001030012301 | 华为移动路由 2 白色（默认） | 颜色=白色 | ¥299 | ¥269（直降30元；2026-08-01 00:00:00+0800 至 2026-08-31 23:59:59+0800） | 显示购买入口 |
...
- 插卡上网 免装宽带，4G 全网通，LTE 195 Mbps，轻薄便携 *受运营商管控要求，新疆、西藏、云南地区将限制流量卡使用，不支持购买
