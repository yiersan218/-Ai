...
source_urls: ["https://www.vmall.com/product/comdetail/index.html?prdId=10086918438323&sbomCode=3001030014801"]
...
|---|---|
| 官网商品名称 | 华为移动路由 5 |
| 商品编号（prdId） | 10086918438323 |
| 品牌 | 华为 |
| 销售 SKU 数量 | 1 |
| 建议刷新日期 | 2026-08-13；超过该日期的时效性问题视为证据不足 |
| 默认 SKU | 3001030014801；华为移动路由 5 |
| SKU 页面标价区间（抓取时） | ¥349 |
| SKU 限时活动价区间（抓取时） | ¥299 |
| 商城搜索列表促销价（抓取时） | ¥299 |
| 店铺 | 华为商城自营 |
| 官网卖点摘要 | 便捷联网；畅享高速网络；双百兆网口 |
| 用户评价快照（抓取时） | 好评率 90%；评价数 125 |
| 官网商品页 | https://www.vmall.com/product/comdetail/index.html?prdId=10086918438323 |
...
|---|---|---|---:|---|---|
| 3001030014801 | 华为移动路由 5（默认） | 颜色=白色 | ¥349 | ¥299（直降50元；2026-08-01 00:00:00+0800 至 2026-08-31 23:59:59+0800） | 显示购买入口 |
