...
source_urls: ["https://www.vmall.com/product/comdetail/index.html?prdId=10086131745276&sbomCode=3001010032701"]
...
|---|---|
| 官网商品名称 | 华为路由 AX2 Pro |
| 商品编号（prdId） | 10086131745276 |
| 品牌 | 华为 |
| 销售 SKU 数量 | 1 |
| 建议刷新日期 | 2026-08-13；超过该日期的时效性问题视为证据不足 |
| 默认 SKU | 3001010032701；华为路由 AX2 Pro |
| SKU 页面标价区间（抓取时） | ¥169 |
| SKU 限时活动价区间（抓取时） | ¥159 |
| 商城搜索列表促销价（抓取时） | ¥159 |
| 店铺 | 华为商城自营 |
| 官网卖点摘要 | Wi-Fi 6；智能加速；上网保护 |
| 用户评价快照（抓取时） | 好评率 98%；评价数 33398 |
| 官网商品页 | https://www.vmall.com/product/comdetail/index.html?prdId=10086131745276 |
...
| 无线频段 | 2.4GHz & 5GHz，支持 WiFi 5GHz 优选 |
...
|---|---|---|---:|---|---|
| 3001010032701 | 华为路由 AX2 Pro（默认） | 颜色=白色 | ¥169 | ¥159（直降10元；2026-08-01 00:00:00+0800 至 2026-08-31 23:59:59+0800） | 显示购买入口 |
