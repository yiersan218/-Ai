...
source_urls: ["https://www.vmall.com/product/comdetail/index.html?prdId=10086478848011&sbomCode=4405010029201"]
...
|---|---|
| 官网商品名称 | 华为智能门锁 M2 |
| 商品编号（prdId） | 10086478848011 |
| 品牌 | 华为 |
| 销售 SKU 数量 | 1 |
| 建议刷新日期 | 2026-08-13；超过该日期的时效性问题视为证据不足 |
| 默认 SKU | 4405010029201；华为智能门锁 M2 |
| SKU 页面标价区间（抓取时） | ¥799 |
| 商城搜索列表促销价（抓取时） | ¥799 |
| 店铺 | 华为商城自营 |
| 官网卖点摘要 | AI 指纹解锁；多重安全防护；18 个月长续航 |
| 用户评价快照（抓取时） | 好评率 98%；评价数 714 |
| 官网商品页 | https://www.vmall.com/product/comdetail/index.html?prdId=10086478848011 |
...
| 属性 | 官网值 |
|---|---|
| 操控方式 | 感应操控（指纹开锁）， 按键式（键盘），NFC |
| 供电方式 | 4节5号干电池 |
| 门锁内屏 | 无 |
| 室外开锁方式 | 指纹识别开锁、密码开锁、访客密码（一次性密码/周期性密码）开锁、钥匙开锁、NFC开锁、双重验证开锁 |

### SKU 明细

| SKU 编码 | 商品/版本 | 配置属性 | 页面标价 | 限时活动价与有效期 | 商品页入口 |
|---|---|---|---:|---|---|
| 4405010029201 | 华为智能门锁 M2（默认） | 颜色=星际黑 | ¥799 |  | 显示购买入口 |
...
- AI 指纹解锁，越开越顺手；多重安全防护，18 个月长续航，安全可靠；4 年主机维保，比行业多一年
