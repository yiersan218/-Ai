...
source_urls: ["https://www.vmall.com/product/comdetail/index.html?prdId=10086122913106&sbomCode=3102060025701"]
...
| 字段 | 官网快照 |
|---|---|
| 官网商品名称 | 华为AI音箱 2e 全屋版 |
| 商品编号（prdId） | 10086122913106 |
| 品牌 | 华为 |
| 销售 SKU 数量 | 1 |
| 建议刷新日期 | 2026-08-13；超过该日期的时效性问题视为证据不足 |
| 默认 SKU | 3102060025701；华为AI音箱 2e 全屋版 贝母白 |
| SKU 页面标价区间（抓取时） | ¥199 |
| 商城搜索列表促销价（抓取时） | ¥199 |
| 店铺 | 华为商城自营 |
| 官网卖点摘要 | 一键畅连通话；全屋智能智慧语音操控 |
| 用户评价快照（抓取时） | 好评率 92%；评价数 78 |
| 官网商品页 | https://www.vmall.com/product/comdetail/index.html?prdId=10086122913106 |

### SKU 明细

| SKU 编码 | 商品/版本 | 配置属性 | 页面标价 | 限时活动价与有效期 | 商品页入口 |
|---|---|---|---:|---|---|
| 3102060025701 | 华为AI音箱 2e 全屋版 贝母白（默认） |  | ¥199 |  | 显示购买入口 |
