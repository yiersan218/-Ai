...
('2608061000000000003','kb-buying-decision','场景化推荐',2,'hwmall-buying','根据预算、用途、偏好和生态搭配给出候选方向；当前价格或在售信息需同时路由到 MCP。','["预算 5000 元推荐拍照好的华为手机","办公学习适合买哪款 MateBook"]','["hwmallguide","hwmallproduct"]',NULL,0,'仅使用稳定知识回答；动态信息另走 MCP。',NULL,11),
('2608061000000000004','mcp-vmall-search','商品页面搜索',2,'hwmall-buying','查找公开的华为商城商品页、商品列表或在售入口；搜索摘要存在索引延迟。','["帮我找 Sound X5 的华为商城页面"]','[]','youcom_search',2,'公开网页搜索线索，不是实时业务数据。','保留商品名、型号、配置和限制条件，只输出 JSON；固定 search_type=product_search，不得编造商品标识或交易事实。',12),
('2608061000000000005','kb-product-comparison','商品对比',2,'hwmall-buying','比较多款硬件的稳定参数、卖点、场景差异和选购取舍；当前价格另走 MCP。','["Mate 80 和 Pura 90 Pro 怎么选"]','["hwmallguide","hwmallproduct"]',NULL,0,'仅使用稳定知识回答；动态信息另走 MCP。',NULL,13),
('2608061000000000006','hwmall-product-knowledge','商品知识',1,'hwmall','稳定参数与卖点、鸿蒙生态兼容，以及使用和通用品类选购知识。','[]','[]',NULL,0,NULL,NULL,20),
('2608061000000000007','kb-product-parameters','参数与卖点',2,'hwmall-product-knowledge','13 类华为硬件的产品家族、稳定规格、功能和核心卖点；排除价格、库存、优惠和动态 SKU。','["HUAWEI WATCH 5 有哪些卖点","Pura 90 Pro 的影像参数是什么"]','["hwmallproduct"]',NULL,0,'仅使用稳定知识回答；动态信息另走 MCP。',NULL,21),
...
('2608061000000000011','mcp-price-stock','价格与在售信息线索',2,'hwmall-current-info','检索公开页面中的当前标价和在售状态线索，不保证实时价格、地区库存或结算价。','["Mate 80 Pro 现在页面标价多少"]','[]','youcom_search',2,'不得把搜索摘要描述为实时库存。','保留型号、配置、地区和商品标识，只输出 JSON；固定 search_type=price_stock，不得编造价格或库存。',31),
('2608061000000000012','mcp-promotion','商城优惠页面',2,'hwmall-current-info','查找当前公开活动页、赠品、优惠券和活动时间说明。','["Pura 系列现在有什么优惠页面"]','[]','youcom_search',2,'活动线索必须保留页面时效边界。','保留商品、品类、活动名和时间条件，只输出 JSON；固定 search_type=promotion，不得编造优惠。',32),
('2608061000000000013','mcp-installment-tradein','分期与以旧换新页面',2,'hwmall-current-info','查找公开分期说明、免息页面和以旧换新入口；不估算个人回收价或资格。','["MateBook 14 有几期免息页面"]','[]','youcom_search',2,'不得承诺个人资格或回收价。','保留新旧商品和分期条件，只输出 JSON；固定 search_type=installment_tradein，不得编造个人资格。',33),
