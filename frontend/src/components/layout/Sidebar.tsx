...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed left-0 top-0 z-40 flex h-[calc(100dvh-var(--site-footer-height))] w-[280px] flex-shrink-0 flex-col bg-[#FAFAFA] p-3 transition-transform lg:static lg:h-full lg:translate-x-0",
        ...
        <div className="border-b border-[#F0F0F0] pb-3">
          <div className="flex items-center gap-3">
            ...
            <div style={{ fontFamily: sessionTitleFont }}>
              <p className="text-base font-semibold text-[#1A1A1A]">知源 AI</p>
