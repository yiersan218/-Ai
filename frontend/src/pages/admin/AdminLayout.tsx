...
export function AdminLayout() {
  ...
  return (
    <div className="admin-layout flex h-full min-h-0">
          ...
          <div className={cn("flex items-center gap-3", collapsed && "justify-center")}>
            ...
            {!collapsed && (
              <div className="min-w-0">
                <h1 className="admin-sidebar__title">知源 AI 管理后台</h1>
      ...
      <div
        className={cn(
          "admin-main flex h-full min-h-0 flex-1 flex-col overflow-auto",
